const ContactMe = () => (
  <div className="flex space-x-4">
    {/* LinkedIn */}
    <a
      href="https://www.linkedin.com/in/anvitha-lakshmisha/"
      target="_blank"
    ...
    {/* GitHub */}
    <a
      href="https://github.com/anvithalakshmisha"
      target="_blank"
      rel="noopener noreferrer"
      className="text-gray-600 hover:text-blue-500"
    >
    ...
    {/* Email */}
    <a
      href="mailto:anvithalakshmisha@gmail.com"
      className="text-gray-600 hover:text-blue-500"
    >
      <svg className="h-8 w-8" fill="currentColor" viewBox="0 0 24 24">
        <path
          fillRule="evenodd"
          d="M22 4H2a2 2 0 00-2 2v12a2 2 0 002 2h20a2 2 0 002-2V6a2 2 0 00-2-2zM2 5.5a.5.5 0 01.5-.5h19a.5.5 0 01.5.5v11a.5.5 0 01-.5.5H2.5a.5.5 0 01-.5-.5v-11z"
          clipRule="evenodd"
        />
        <path
          fillRule="evenodd"
          d="M12.707 13.207a.5.5 0 01-.707 0l-5.5-5a.5.5 0 11.707-.707L12 11.793l5.5-5a.5.5 0 01.707.707l-5.5 5z"
          clipRule="evenodd"
        />
        <path
          fillRule="evenodd"
          d="M6.5 8.5l-1 1V16h13v-6l-1-1v7H6.5v-7z"
          clipRule="evenodd"
        />
      </svg>
    </a>
